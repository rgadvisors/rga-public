...
|---|---|---|---|
| [Self-interview, Claude edition](self-interview/) | A prompt you paste into a new Claude conversation that interviews you and writes your instruction files, with the setup instructions and the month-two tune-up | 2.2.0 | 2026-09-06 |
